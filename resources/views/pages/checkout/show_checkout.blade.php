...
<input type="text" 
name="shipping_name" placeholder="Họ và tên">
...
<textarea 
name="shipping_notes" placeholder="Ghi chú đơn hàng của bạn" 
rows="16"></textarea>
...
class="form-control input-sm m-bot15 payment_select">
 <option value="0">Giao theo địa 
chỉ</option>
 <option value="1">Nhận tại 
shop</option> 
 </select>
 </div>
<input type="submit" 
value="Gửi xác nhận" name="send_order" class="btn btn-primary btn-sm">
</form>
</div>
