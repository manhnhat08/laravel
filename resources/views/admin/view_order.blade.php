...
<div class="table-agile-info">
 ...
 <td>@if($shipping->shipping_method==0) Chuyển khoản @else Tiền mặt 
@endif</td>
...
<div class="table-agile-info">
 ...
 @endforeach
 <tr>
 <td colspan="2"> Thanh toán: {{number_format($total,0,',','.')}}đ
 </td>
 </tr>
 </tbody>
 </table>
...
<div class="col-md-6">
 <form role="form" action="{{URL::to(('/update-order/'.$details->order_id))}}" 
method="post" enctype="multipart/form-data">
 ...
 <option id="{{$or->order_id}}" selected value="1">Chưa xửlý</option>
